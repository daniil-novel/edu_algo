...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 66 + 86) / 173)
exe 'vert 2resize ' . ((&columns * 59 + 86) / 173)
exe 'vert 3resize ' . ((&columns * 24 + 86) / 173)
exe '4resize ' . ((&lines * 21 + 21) / 42)
exe 'vert 4resize ' . ((&columns * 21 + 86) / 173)
exe '5resize ' . ((&lines * 18 + 21) / 42)
exe 'vert 5resize ' . ((&columns * 21 + 86) / 173)
argglobal
...
silent! normal! zE
let &fdl = &fdl
let s:l = 92 - ((9 * winheight(0) + 20) / 40)
...
wincmd w
argglobal
if bufexists("alg12v2.cpp") | buffer alg12v2.cpp | else | edit alg12v2.cpp | endif
balt data.txt
nnoremap <buffer> \> Icin >> $a;$
nnoremap <buffer> \< Icout << $a << endl;$
nmap <buffer> \b \}
...
silent! normal! zE
let &fdl = &fdl
let s:l = 41 - ((17 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 41
...
badd +15 ../alg5/dataGeneratorv3.py
badd +0 data2.txt
badd +0 data6.txt
