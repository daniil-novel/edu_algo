...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 50 + 86) / 173)
exe '2resize ' . ((&lines * 12 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 35 + 86) / 173)
exe '3resize ' . ((&lines * 26 + 20) / 41)
exe 'vert 3resize ' . ((&columns * 35 + 86) / 173)
exe 'vert 4resize ' . ((&columns * 36 + 86) / 173)
exe '5resize ' . ((&lines * 31 + 20) / 41)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 51 - ((24 * winheight(0) + 19) / 39)
...
wincmd w
argglobal
if bufexists("alg5.py") | buffer alg5.py | else | edit alg5.py | endif
balt ../alg3/alg3-tree.py
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
...
wincmd w
argglobal
if bufexists("dataGeneratorv3.py") | buffer dataGeneratorv3.py | else | edit dataGeneratorv3.py | endif
balt dataGeneratorv2.py
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
...
tabnext 1
badd +1 alg5v3.cpp
badd +49 ~/alg/alg5/alg5.cpp
badd +1 alg5.py
badd +41 ../alg3/alg3-tree.py
badd +20 dataGeneratorv3.py
badd +11 ~/alg/alg3/dataGenerator.py
badd +1 data1.txt
badd +18 ~/alg/alg2/dataGenerator.py
badd +24 ~/alg/alg1/dataGenerator.py
badd +1 data.txt
badd +1 alg5v2.cpp
badd +42 ~/alg/alg1/alg1v3-vv.cpp
badd +1 ~/alg/alg1/alg1v2-Pair.cpp
badd +1 ~/alg/alg1/alg1v3.cpp
badd +1 ~/alg/alg1/alg1v4-multimap.cpp
badd +1 ~/alg/alg2/alg2-unordered-mapv2.cpp
badd +19 ~/alg/alg2/alg2-unordered-map.cpp
badd +15 dataGenerator.py
badd +1 dataGeneratorv2.py
badd +0 data2.txt
