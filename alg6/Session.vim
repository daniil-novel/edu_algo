...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 114 + 73) / 146)
exe '2resize ' . ((&lines * 28 + 17) / 34)
exe 'vert 2resize ' . ((&columns * 29 + 73) / 146)
exe '3resize ' . ((&lines * 10 + 17) / 34)
exe 'vert 3resize ' . ((&columns * 1 + 73) / 146)
exe '4resize ' . ((&lines * 17 + 17) / 34)
exe 'vert 4resize ' . ((&columns * 1 + 73) / 146)
exe '5resize ' . ((&lines * 3 + 17) / 34)
exe 'vert 5resize ' . ((&columns * 31 + 73) / 146)
argglobal
balt data.txt
lnoremap <buffer> " Э
lnoremap <buffer> # №
...
wincmd w
argglobal
if bufexists("~/alg/alg5/alg5v3.cpp") | buffer ~/alg/alg5/alg5v3.cpp | else | edit ~/alg/alg5/alg5v3.cpp | endif
balt alg6.cpp
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
...
wincmd w
argglobal
if bufexists("../alg2/alg2-unordered-mapv2.cpp") | buffer ../alg2/alg2-unordered-mapv2.cpp | else | edit ../alg2/alg2-unordered-mapv2.cpp | endif
balt alg6.cpp
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
...
wincmd w
argglobal
if bufexists("alg6.cpp") | buffer alg6.cpp | else | edit alg6.cpp | endif
balt ../alg2/alg2-unordered-mapv2.cpp
lnoremap <buffer> " Э
lnoremap <buffer> # №
lnoremap <buffer> $ ;
lnoremap <buffer> & ?
...
badd +0 alg6.cpp
badd +0 data.txt
badd +1 ~/alg/alg5/alg5v3.cpp
badd +40 ../alg5/alg5v2.cpp
badd +0 ../alg2/alg2-unordered-mapv2.cpp
